...
class User(Base):
    ...
    UserPhoto: Mapped[str] = mapped_column(VARCHAR(255), comment='用户头像路径')
    ...
    TeamJoinApplication: Mapped[List['TeamJoinApplication']] = relationship('TeamJoinApplication', foreign_keys='[TeamJoinApplication.FromUserId]', back_populates='User_')
    TeamJoinApplication_: Mapped[List['TeamJoinApplication']] = relationship('TeamJoinApplication', foreign_keys='[TeamJoinApplication.HandlerUserId]', back_populates='User1')
    TeamJoinApplication1: Mapped[List['TeamJoinApplication']] = relationship('TeamJoinApplication', foreign_keys='[TeamJoinApplication.ToUserId]', back_populates='User2')
