...
def upgrade() -> None:
    ...
    op.create_index('HighestGradeId', 'Player', ['HighestGradeId'], unique=False)
    op.create_index('PrimaryLocationId', 'Player', ['PrimaryLocationId'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('PrimaryLocationId', table_name='Player')
    op.drop_index('HighestGradeId', table_name='Player')
    op.drop_index('CurrentGradeId', table_name='Player')
