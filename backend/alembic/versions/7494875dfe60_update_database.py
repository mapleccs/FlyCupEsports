...
Revision ID: 7494875dfe60
Revises: 
Create Date: 2025-07-15 15:23:58.782788
...
def upgrade() -> None:
    ...
    sa.Column('UserPhoto', mysql.VARCHAR(length=255), nullable=True, comment='用户头像路径'),
    sa.PrimaryKeyConstraint('Id')
    )
    ...
    op.create_index('RegionId', 'Competitor', ['RegionId'], unique=False)
    ...
    op.create_table('TeamCompetitor',
    sa.Column('Id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['CompetitorId'], ['Competitor.Id'], name='TeamUser_ibfk_2'),
    ...
    op.create_index('CompetitorId', 'TeamCompetitor', ['CompetitorId'], unique=False)
    op.create_index('TeamId', 'TeamCompetitor', ['TeamId'], unique=False)
    op.create_index('TeamRoleId', 'TeamCompetitor', ['TeamRoleId'], unique=False)
    ...
    sa.ForeignKeyConstraint(['FromCompetitorId'], ['Competitor.Id'], name='TeamJoinApplication_ibfk_1'),
    sa.ForeignKeyConstraint(['HandlerCompetitorId'], ['Competitor.Id'], name='TeamJoinApplication_ibfk_4'),
    sa.ForeignKeyConstraint(['TeamId'], ['Team.Id'], name='TeamJoinApplication_ibfk_3'),
    sa.ForeignKeyConstraint(['ToCompetitorId'], ['Competitor.Id'], name='TeamJoinApplication_ibfk_2'),
    sa.PrimaryKeyConstraint('Id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index('TeamRoleId', table_name='TeamCompetitor')
    op.drop_index('TeamId', table_name='TeamCompetitor')
    op.drop_index('CompetitorId', table_name='TeamCompetitor')
    op.drop_table('TeamCompetitor')
    op.drop_index('UserId', table_name='Competitor')
    op.drop_index('SecondaryLocationId', table_name='Competitor')
    op.drop_index('RegionId', table_name='Competitor')
